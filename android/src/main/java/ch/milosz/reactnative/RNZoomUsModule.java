...
public class RNZoomUsModule extends ReactContextBaseJavaModule implements ZoomSDKInitializeListener, MeetingServiceListener, LifecycleEventListener {
        ...
        try {
            ...
            if (meetingService.getMeetingStatus() != MeetingStatus.MEETING_STATUS_IDLE) {
                ...
                if (meetingService.getCurrentRtcMeetingNumber() == lMeetingNo) {
                    meetingService.returnToMeeting(reactContext);
            ...
            int startMeetingResult = meetingService.startMeetingWithParams(reactContext, params, opts);
    ...
    @Override // TODO handle this case
